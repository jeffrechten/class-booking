<?php
    ...
    if(isset($_POST['Action'])) {
        ...
        if($Action  == "class-details") {
            ...
            $DateFormat = "j M Y"; //$DateFormat = "d-m-Y";
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        //if($Repeat == "none") {
                                            echo date($DateFormat, strtotime($JoiningDate));
                                        //} else {
                                            //echo date($DateFormat, strtotime($JoiningDate))." <strong>-</strong> ".date($DateFormat, strtotime($JoiningDate));
                                       // }
                                        ?>
                                    </td>
                                </tr>
